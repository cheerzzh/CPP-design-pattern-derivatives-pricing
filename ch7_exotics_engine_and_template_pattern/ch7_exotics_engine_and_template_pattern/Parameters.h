...
#ifndef __ch7_exotics_engine_and_template_pattern__Parameters__
#define __ch7_exotics_engine_and_template_pattern__Parameters__
...
#endif /* defined(__ch7_exotics_engine_and_template_pattern__Parameters__) */
